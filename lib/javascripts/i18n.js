(function(){
  ...
  //in the default option. Strings starting with ":" will be considered
  ...
  I18n.lookup = function(keys, defaults){
    var key, i, value = this.translations[locale()];
    ...
    if (value){
      ...
      if (defaults.length == 0) {
        ...
        return this.lookup(keyToArray(defaults[0].substr(1)), defaults.slice(1));
      } else {
        return defaults[0];
      }
    }
